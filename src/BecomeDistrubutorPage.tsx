      ...
      <section>
        <div className=" grid grid-cols-12 w-full gap-6 px-4 md:px-20 mt-40  ">
          ...
          <div className="text-white flex flex-col space-y-5 font-light text-base leading-loose  col-span-6">
            <p>
              Weight: 1 kg <br /> Number of cubes: 72 <br /> Size: 25x25x25 <br />
              Features: The box
              is additionally packed in heat resistant film ,Inside the box 2
              individual bags Minimum order quantity: 30 kg Delivery:
              self-delivery from the warehouse in Moscow / by transportation
              company (cost not included) The transportation box contains 10
              pack
            </p>
          </div>
        </div>
