          ...
          <div className="grid grid-cols-12 h-[600px] gap-6  px-4 md:px-20">
            ...
            >
              ...
              <p>
                ...
                packaging materials. Highlight any initiatives to reduce plastic
                use or carbon footprint in the production and distribution
                process.
              </p>
            </div>
              ...
              <div className=" bg-lightgray rounded-lg basis-full ">
                <div className=" text-white space-y-5 p-4 font-light text-sm leading-loose">
                  ...
                  <p>
                    ...
                    money-back guarantee if customers are not completely
                    satisfied with their purchase. This builds trust and shows
              ...
              <div className=" bg-lightgray rounded-lg basis-full ">
                <div className=" text-white space-y-5 p-4  font-light text-sm leading-loose">
                  ...
                  <p>
                    ...
                    minimal smoke, making it ideal for both outdoor and indoor
                    (with proper ventilation) grilling. This feature is
                    particularly appealing for those in urban settings or with
                    close neighbors.
                  </p>
                </div>
              </div>
              ...
              <div className=" bg-lightgray rounded-lg basis-full ">
                <div className=" text-white space-y-5 p-4  font-light text-sm leading-loose">
                  <p>
                    ...
                    to customers. Emphasize the balance of quality and
                    affordability.
                  </p>
                  <p>
                    we offer fast and reliable shipping, with quick processing
                    times and partnerships with reliable carriers, and offers
