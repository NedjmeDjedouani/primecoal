    ...
    <div className="bg-black flex flex-col">
      ...
      <section className="w-full mt-20   ">
        <div className="flex items-center justify-center col-span-12">
          <h1 className="text-white uppercase font-bold text-center pb-[100px] ">
            the Best Sustainable Barbecue Charcoal you will ever use!
          </h1>
        </div>
        <div className="grid grid-cols-12 h-[600px] gap-6 ">
          <div
          ...
          <div className=" col-span-4  flex flex-col space-y-5">
            <div className=" bg-lightgray rounded-lg flex-1 ">
